...
<div class="confirmPayPageDiv">
    ...
    <div class="confirmPayOrderInfoDiv"><div class="confirmPayOrderInfoText">我已收货，同意支付宝付款</div></div>
        ...
        <table class="confirmPayOrderDetailTable">
            ...
            <c:forEach items="${o.orderItems}" var="oi">
                <tr>
                    ...
                    <td>1</td>
                    <td><span class="confirmPayProductPrice">¥<fmt:formatNumber type="number" value="${oi.product.promotePrice}" minFractionDigits="2"/></span></td>
                    <td><span>快递：0.00</span></td>
                </tr>
            </c:forEach>
        </table>
        <div class="confirmPayOrderItemText pull-right">实付款：
            <span class="confirmPayOrderItemSumPrice">¥<fmt:formatNumber type="number" value="${o.total}" minFractionDigits="2"/></span>
        </div>
    </div>
    ...
    <div class="confirmPayButtonDiv">
        ...
        <a href="foredealSuccess?oid=${o.id}"><button class="confirmPayButton">确认支付</button></a>
    </div>
</div>
