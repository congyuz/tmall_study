...
<div class="searchProducts">
    <c:forEach items="${ps}" var="p">
        <div class="productUnit" price="${p.promotePrice}">
            <a href="foreproduct?pid=${p.id}"><img class="productImage" src="img/productsSingle/${p.firstProductImage.id}.jpg"></a>
    ...
    <c:if test="${empty ps}"><div class="noMatch">没有满足条件的产品</div></c:if>
