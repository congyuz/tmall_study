...
<script>
    $(function(){
        ...
        $("button.loginSubmitButton").click(function () {
            ...
            $.get(page,{"name":name,"password":password},function (result) {
    ...
    <div class="imgInimgAndInfo">
        ...
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="img/productSingle_small/${pi.id}.jpg" bigImageURL="img/productSingle/${pi.id}.jpg" class="smallImg">
            </c:forEach>
        </div>
